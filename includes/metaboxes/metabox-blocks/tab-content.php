    ...
    <div id="all-columns-wrap">
        <div class="column zero">
            ...
            <ul class="ptp-settings explaination-settings">
                <li class="monthly explaination-desc">
                    <strong><?php _e('Monthly Pricing', PTP_LOC); ?></strong><i class="ptp-icon-help-circled" data-trigger="hover" data-html="true" data-placement="right" data-original-title="&lt;strong&gt;<?php _e('Monthly Pricing', PTP_LOC); ?>&lt;/strong&gt;" data-content="
					            <?php _e('Enter your pricing options here.', PTP_LOC); ?>
					            "></i>
                </li>
                <li class="yearly explaination-desc">
                    <strong><?php _e('Yearly Pricing', PTP_LOC); ?></strong><i class="ptp-icon-help-circled" data-trigger="hover" data-html="true" data-placement="right" data-original-title="&lt;strong&gt;<?php _e('Yearly Pricing', PTP_LOC); ?>&lt;/strong&gt;" data-content="
                                <?php _e('Enter your pricing options here.', PTP_LOC); ?>
                                "></i>
                </li>
        ...
        while($mb->have_fields_and_multi('column',array('length' => 2))):
            ...
            <div class="column">
                ...
                <ul class="ptp-settings plan-settings">
                    <li>
                        <?php $mb->the_field('planmonthlyprice'); ?>
                        <input type="text" name="<?php $mb->the_name(); ?>" placeholder="<?php _e('e.g. $49', PTP_LOC); ?>" value="<?php echo $mb->the_value(); ?>" class="form-control">
                    </li>
                    <li>
                        <?php $mb->the_field('planyearlyprice'); ?>
                        <input type="text" name="<?php $mb->the_name(); ?>" placeholder="<?php _e('e.g. $499', PTP_LOC); ?>" value="<?php echo $mb->the_value(); ?>" class="form-control">
                    </li>
                    <li class="features">
